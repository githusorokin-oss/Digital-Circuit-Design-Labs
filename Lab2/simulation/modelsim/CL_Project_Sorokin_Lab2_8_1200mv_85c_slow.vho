...
ENTITY 	CL_Project_Sorokin_Lab2 IS
    PORT (
	outs : OUT std_logic;
	inx : IN std_logic;
	iny : IN std_logic;
...
-- inz	=>  Location: PIN_R1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- inx	=>  Location: PIN_L6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- iny	=>  Location: PIN_P2,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF CL_Project_Sorokin_Lab2 IS
...
-- Equation(s):
-- \inst|LPM_ADD_SUB_component|auto_generated|sum_eqn[0]~0_combout\ = \inz~input_o\ $ (((\inx~input_o\ & \iny~input_o\)))
...
-- Equation(s):
-- \inst4~0_combout\ = (\inx~input_o\ & ((\inz~input_o\) # (!\iny~input_o\))) # (!\inx~input_o\ & ((\iny~input_o\)))
